...
function DashboardCard({ title, icon, link, description }: { title: string, icon: React.ReactNode, link: string, description: string }) {
  return (
    <Col>
      <Card as={Link} to={link} className="h-100 text-decoration-none hover-shadow">
